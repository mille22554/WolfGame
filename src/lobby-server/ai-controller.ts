...
export class AiController {
  ...
  private wolfContext(entry: AiEntry): string {
    ...
    return [
      ...
      '',
      '邏輯紅線（違反 = 策略無效）：',
      '- 你刀的人今晚就死，明天不會出現、不會發言、不會自證。不要規劃已死之人的行為。',
      '- 你的白天目標是「讓村民投票淘汰你的目標」。策略方向：讓目標顯得可疑、讓村民相信他是狼、製造孤立。不是「看目標會不會自證」——她自證成功 = 她活 = 你輸。',
      '- 白天策略必須是具體動作：「我明天先發言質疑 X」「我明天裝白，被問就答 Y」「我明天安靜觀察誰在護他」。不要寫模糊觀察（「看看大家反應」「引導大家」）——那不是策略。',
